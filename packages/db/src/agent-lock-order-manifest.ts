...
export const agentLockStatementManifest: readonly AgentLockStatementManifestEntry[] = [
  ...
  lock("144:9:be92840ddb67de9839750515a47163747caf8e6c0397f8c22e43e7bde7f58bfd#1","144:9","apps/api/src/agent-connections.ts","POST /api/v1/agent-connections",["agent_definitions"]),
  ...
  write("251:24:c3eb2849278cd3a742530b6b48af803f4930895199aa67d6534a1c6c40febb25#1","251:24","apps/api/src/agent-connections.ts","PATCH /api/v1/agent-connections/:id",["delegations"]),
  write("268:22:e96fc22329787c245913890c96e241d0e080c1e4c6d60e5490966800b6772825#1","268:22","apps/api/src/agent-connections.ts","DELETE /api/v1/agent-connections/:id",["agent_sessions"]),
  write("269:22:2292abeccafd719abd1629d15e0f16e17d1d48c667cc44d63bc0a12b63a739f7#1","269:22","apps/api/src/agent-connections.ts","DELETE /api/v1/agent-connections/:id",["delegations"]),
  ...
  write("331:80:85670f26d44d2f9665d308a98c4802c39abf29bbc589887fe06bbcd744c31055#1","331:80","apps/api/src/agent-connections.ts","resolveCoordinationIdentity",["agent_sessions"]),
