...
export const agentLockStatementManifest: readonly AgentLockStatementManifestEntry[] = [
  ...
  write("128:9:d560d3a4c80db6635ba0f86fcc5e80d07b328f174e0f7f449db9b0bf2743f4fa#1","128:9","apps/api/src/agent-connections.ts","POST /api/v1/agent-connections",["agent_team_access"]),
  ...
  write("212:54:c3eb2849278cd3a742530b6b48af803f4930895199aa67d6534a1c6c40febb25#1","212:54","apps/api/src/agent-connections.ts","PATCH /api/v1/agent-connections/:id",["delegations"]),
  ...
  write("88:9:42ae42f01bfc21b9d179576fed47f2cc99eaa92ba3bc81c9e5f1a6abd466fc1b#1","88:9","apps/worker/src/agent-connections.ts","tick",["agent_sessions"]),
