...
export const routeOperationBindings = [
  ...
  { "method": "POST", "path": "/api/v1/workbench/conversations/{id}/turns/{turnId}/steer", "operationId": "steerWorkbenchTurn" },
  { "method": "POST", "path": "/api/v1/workbench/conversations/{id}/turns/{turnId}/followup", "operationId": "followupWorkbenchTurn" },
  { "method": "PATCH", "path": "/api/v1/workbench/conversations/{id}/context-pins", "operationId": "updateWorkbenchConversationContextPins" },
