...
const tourCases = [
  ...
  },
  {
    ...
    route: '/settings?team=team-page-2',
    ...
    dominantSelector: '.settings-grid',
    initialMcpReadiness401Count: 0,
    minimumTouchTarget: true,
    wideContract: 'settings-workspace',
  },
  {
    slug: 'operations-failed-runs',
    route: '/operations?opsQuery=Failed#operations-runs',
