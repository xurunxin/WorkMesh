...
export function normalizeRoomTimelineItem(item: RoomRecord): RoomRecord {
  ...
  return {
    ...
    actorId: stringValue(item, 'actorId', 'actor_id') || stringValue(details, 'actorId', 'actor_id', 'authorActorId', 'author_actor_id'),
    actorName: stringValue(item, 'actorName', 'actor_name') || stringValue(details, 'displayName', 'display_name', 'actorDisplayName', 'actor_display_name', 'authorDisplayName', 'author_display_name'),
    actorKind: stringValue(item, 'actorKind', 'actor_kind') || stringValue(details, 'actorKind', 'actor_kind'),
    sessionId: stringValue(item, 'sessionId', 'session_id') || stringValue(details, 'sessionId', 'session_id', 'fromSessionId', 'from_session_id'),
    planStepId: stringValue(item, 'planStepId', 'plan_step_id') || stringValue(details, 'planStepId', 'plan_step_id'),
    createdAt: stringValue(item, 'createdAt', 'created_at', 'occurredAt', 'occurred_at') || stringValue(details, 'createdAt', 'created_at'),
