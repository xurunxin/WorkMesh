...
describe('AuthenticatedRuntime', () => {
  ...
  it('mounts realtime, page hotkeys and one command center on an authenticated workspace route', async () => {
    ...
    render(<LocaleProvider><AuthenticatedRuntime commandCenter={<CommandCenterMount />}><><div data-wm-hydrated="true" id="workmesh-command-center-trigger-slot" /><main>Agents content</main></></AuthenticatedRuntime></LocaleProvider>)
