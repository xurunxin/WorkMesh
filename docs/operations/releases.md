...
After a controlled restart, the production smoke waits for both application
readiness and Docker health state before asserting the final lifecycle report;
the two signals can converge at different times because healthchecks are
interval-based.
