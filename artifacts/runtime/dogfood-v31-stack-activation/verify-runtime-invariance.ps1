...
$future = @('artifacts\approvals\dogfood-v31-stack-activation-request.json','artifacts\approvals\dogfood-v31-stack-activation-human-approval.json','artifacts\runtime\dogfood-v31-stack-activation.json','artifacts\runtime\dogfood-v31-stack-rollback.json')
$present = @($future | Where-Object { Test-Path -LiteralPath (Join-Path $controlRoot $_) })
